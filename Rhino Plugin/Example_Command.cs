...
{
    public class Example_Command : Command
    {
        public override string EnglishName => "Example_Command";

        protected override Result RunCommand(RhinoDoc doc, RunMode mode)
        {
            // reference: https://developer.rhino3d.com/samples/rhinocommon/add-command-line-options/
